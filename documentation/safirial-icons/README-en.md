# Safirial Icons – SVG Icons Package

**Safirial Icons** is an SVG icons package designed for web applications.  

This package can be used independently or together with the `catarina` design system.
