...
import { DefaultDynamicIconAbstractClass } from '../default-dynamic-icon-abstract-class';
...
export class UiIconChevronArrow extends DefaultDynamicIconAbstractClass {
  override color: string = 'var(--contrast-neutral-color-9)';
  @Input() rotation: string = '';

  public override applyProperties(properties: Map<string, string>) {
    this.rotation = properties.get('rotation') || '0';
  }
}
