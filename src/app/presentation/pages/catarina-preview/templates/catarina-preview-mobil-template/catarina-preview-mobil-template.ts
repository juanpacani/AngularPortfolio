...
@Component({
  selector: 'app-catarina-preview-mobil-template',
  imports: [
        //Angular
    NgFor,
    NgIf,
  ...
  templateUrl: './catarina-preview-mobil-template.html',
  styleUrl: './catarina-preview-mobil-template.scss'
})
export class CatarinaPreviewMobilTemplate {
clickCount = 0;
