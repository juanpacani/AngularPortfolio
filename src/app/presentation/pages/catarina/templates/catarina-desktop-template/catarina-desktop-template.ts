...
import languages from '../catarina-languages.json';

@Component({
  selector: 'app-catarina-desktop-template',
  imports: [
    //Angular
    NgFor,
    NgIf,
  ...
  templateUrl: './catarina-desktop-template.html',
  styleUrl: './catarina-desktop-template.scss'
})
export class CatarinaDesktopTemplate implements OnInit, OnDestroy {
  clickCount = 0;
