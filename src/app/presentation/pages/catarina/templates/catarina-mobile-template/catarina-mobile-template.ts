...
@Component({
  selector: 'app-catarina-mobile-template',
  imports: [
        //Angular
    NgFor,
    NgIf,
  ...
  templateUrl: './catarina-mobile-template.html',
  styleUrl: './catarina-mobile-template.scss'
})
export class CatarinaMobileTemplate implements OnInit, OnDestroy {
  clickCount = 0;
